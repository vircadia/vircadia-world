                    ...
                    <v-app-bar ref="mainAppBar" density="compact" color="primary" flat app>
                        ...
                        <v-tooltip location="bottom">
                            <template #activator="{ props }">
                                <v-badge :content="0" color="secondary" overlap location="bottom start" offset-x="10"
                                    offset-y="10" :model-value="false" class="ml-2">
...
function onAuthDenied(reason: string) {
