...
VALUES
    ...
    ('avatar.definition.default', 'animations', '[
        ...
        {"fileName":"babylon.avatar.animation.f.crouch_strafe_left.glb","slMotion":"crouchwalk","direction":"left"},
        {"fileName":"babylon.avatar.animation.f.crouch_strafe_right.glb","slMotion":"crouchwalk","direction":"right"},
        {"fileName":"babylon.avatar.animation.f.crouch_walk_back.glb","slMotion":"crouchwalk","direction":"back"},
        ...
        {"fileName":"babylon.avatar.animation.f.jog_back.glb","slMotion":"run","direction":"back","variant":"jog"},
        {"fileName":"babylon.avatar.animation.f.jog.glb","slMotion":"run","direction":"forward","variant":"jog"},
        ...
        {"fileName":"babylon.avatar.animation.f.run_back.glb","slMotion":"run","direction":"back"},
        {"fileName":"babylon.avatar.animation.f.run_strafe_left.glb","slMotion":"run","direction":"left"},
        {"fileName":"babylon.avatar.animation.f.run_strafe_right.glb","slMotion":"run","direction":"right"},
        {"fileName":"babylon.avatar.animation.f.run.glb","slMotion":"run","direction":"forward"},
        {"fileName":"babylon.avatar.animation.f.strafe_left.glb","slMotion":"walk","direction":"left"},
        {"fileName":"babylon.avatar.animation.f.strafe_right.glb","slMotion":"walk","direction":"right"},
        ...
        {"fileName":"babylon.avatar.animation.f.walk_back.glb","slMotion":"walk","direction":"back"},
        ...
        {"fileName":"babylon.avatar.animation.f.walk_strafe_left.glb","slMotion":"walk","direction":"left"},
        {"fileName":"babylon.avatar.animation.f.walk_strafe_right.glb","slMotion":"walk","direction":"right"}
    ]'::jsonb, 'public.STATIC')
ON CONFLICT (general__entity_name, metadata__key) DO UPDATE SET
    metadata__value = EXCLUDED.metadata__value,
    group__sync = EXCLUDED.group__sync;