...
describe("DB -> Auth Tests", () => {
    ...
    //             await tx`SELECT auth.set_agent_context_from_session_id(${admin.id}::uuid)`; // Set to admin context
    ...
    //             await tx`SELECT auth.set_agent_context_from_session_id(${agent.sessionId})`;
