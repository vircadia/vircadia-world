...
describe("World Tick Manager - HEALTH", () => {
    test("Health Check - Stats Endpoint", async () => {
        ...
        const statsEndpoint = `http://${VircadiaConfig.SERVER.VRCA_SERVER_SERVICE_TICK_HOST_CLUSTER}:${VircadiaConfig.SERVER.VRCA_SERVER_SERVICE_TICK_PORT_CLUSTER}${Service.Tick.Stats_Endpoint.path}`;
