...
-- NOTE: As of the High-Performance Refactor, this layer no longer drives the game execution.
-- It now serves as the PERSISTENCE layer for asynchronous snapshots generated by the Runtime Game Loop (GameLoopManager).
-- The 'tick' tables below act as history/save-states rather than the authoritative live state.
-- ============================================================================
