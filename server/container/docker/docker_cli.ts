...
export async function up() {
    log({
        message: `Starting ${VircadiaConfig.SERVER.CONTAINER_NAME} services...`,
        type: "info",
        suppress: VircadiaConfig.SERVER.SUPPRESS,
        debug: VircadiaConfig.SERVER.DEBUG,
    });
    ...
    log({
        message: `Waiting for ${VircadiaConfig.SERVER.CONTAINER_NAME} services to be ready...`,
        type: "info",
        suppress: VircadiaConfig.SERVER.SUPPRESS,
        debug: VircadiaConfig.SERVER.DEBUG,
    });
    if (!(await waitForHealthy())) {
        throw new Error(
            `${VircadiaConfig.SERVER.CONTAINER_NAME} services failed to start properly after 30 seconds`,
        );
    }
    log({
        message: `${VircadiaConfig.SERVER.CONTAINER_NAME} services are ready`,
        type: "success",
        suppress: VircadiaConfig.SERVER.SUPPRESS,
        debug: VircadiaConfig.SERVER.DEBUG,
    });
    ...
    try {
        ...
        log({
            message: `Running initial migrations for ${VircadiaConfig.SERVER.CONTAINER_NAME}...`,
            type: "info",
            suppress: VircadiaConfig.SERVER.SUPPRESS,
            debug: VircadiaConfig.SERVER.DEBUG,
        });
    ...
    log({
        message: `${VircadiaConfig.SERVER.CONTAINER_NAME} container started successfully.`,
        type: "success",
        suppress: VircadiaConfig.SERVER.SUPPRESS,
        debug: VircadiaConfig.SERVER.DEBUG,
    });
...
export async function down() {
    log({
        message: `Stopping ${VircadiaConfig.SERVER.CONTAINER_NAME} container...`,
        type: "info",
        suppress: VircadiaConfig.SERVER.SUPPRESS,
        debug: VircadiaConfig.SERVER.DEBUG,
    });
    ...
    log({
        message: `${VircadiaConfig.SERVER.CONTAINER_NAME} container stopped`,
        type: "success",
        suppress: VircadiaConfig.SERVER.SUPPRESS,
        debug: VircadiaConfig.SERVER.DEBUG,
    });
...
export async function rebuildContainer() {
    log({
        message: `Performing hard reset of ${VircadiaConfig.SERVER.CONTAINER_NAME} container...`,
        type: "info",
        suppress: VircadiaConfig.SERVER.SUPPRESS,
        debug: VircadiaConfig.SERVER.DEBUG,
    });
    ...
    log({
        message: `Container ${VircadiaConfig.SERVER.CONTAINER_NAME} removed, rebuilding...`,
        type: "info",
    });
    await runDockerCommand(["up", "-d", "--build"]);
    log({
        message: `${VircadiaConfig.SERVER.CONTAINER_NAME} container reset complete, running migrations...`,
        type: "info",
        suppress: VircadiaConfig.SERVER.SUPPRESS,
        debug: VircadiaConfig.SERVER.DEBUG,
    });
    ...
    log({
        message: `${VircadiaConfig.SERVER.CONTAINER_NAME} database migrations applied`,
        type: "success",
        suppress: VircadiaConfig.SERVER.SUPPRESS,
        debug: VircadiaConfig.SERVER.DEBUG,
    });
...
export async function resetDatabase() {
    log({
        message: `Performing soft reset of ${VircadiaConfig.SERVER.CONTAINER_NAME} database...`,
        type: "info",
        suppress: VircadiaConfig.SERVER.SUPPRESS,
        debug: VircadiaConfig.SERVER.DEBUG,
    });
    ...
    log({
        message: `${VircadiaConfig.SERVER.CONTAINER_NAME} database reset complete. Running migrations...`,
        type: "info",
        suppress: VircadiaConfig.SERVER.SUPPRESS,
        debug: VircadiaConfig.SERVER.DEBUG,
    });
    ...
    log({
        message: `${VircadiaConfig.SERVER.CONTAINER_NAME} database reset and migration complete.`,
        type: "success",
        suppress: VircadiaConfig.SERVER.SUPPRESS,
        debug: VircadiaConfig.SERVER.DEBUG,
    });
...
export async function migrate(data: {
    ...
    log({
        message: `${VircadiaConfig.SERVER.CONTAINER_NAME} container migrations applied`,
        type: "success",
    });
}
...
export async function generateDbConnectionString(): Promise<string> {
    const config = VircadiaConfig.SERVER.POSTGRES;
